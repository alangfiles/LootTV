...
function preload() {
  ...
  this.load.spritesheet(
    "player_handgun",
    "src/assets/sprites/player_handgun.png",
    {
      frameWidth: 66,
      frameHeight: 60
    }
  ); // Made by tokkatrain: https://tokkatrain.itch.io/top-down-basic-set
  this.load.image("bullet", "src/assets/sprites/bullets/bullet6.png");
  this.load.image("target", "src/assets/demoscene/ball.png");
  this.load.image("background", "src/assets/skies/underwater1.png");
}
